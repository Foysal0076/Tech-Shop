...
import { Form, FormGroup, FormLabel, Button, FormControl, FormFile } from 'react-bootstrap'
...
const ProductEditScreen = ({ match, history }) => {
    ...
    const uploadFileHandler = async (e) => {
        const file = e.target.files[0] //We are taking the first item. becauyse we are uploading a single file
